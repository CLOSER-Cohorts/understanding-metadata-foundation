...
??? success "Answer"
    ...
    **TRUE**
    ...
    For example, temperature can be expressed in degrees Celsius or Fahrenheit, and time spent on an activity can be measured in minutes or hours.
