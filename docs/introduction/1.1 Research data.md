...
1. **Complete the missing step: Concept &rarr; ??? &rarr; data**
...
??? success "**Answer**"
    ...
    1. Complete the missing step: Concept &rarr; **measure** &rarr; data
    2. Different data using different units of measurement can convey the same information **TRUE** - The same concept can be measured in different units. Temperature can be expressed in degrees Celsius or Fahrenheit, and time spent on an activity can be measured in minutes or hours for example. 
    3. Data is used as evidence in the research process and supports and validates research findings.
