...
!!! question "What data is available in the weather app screenshot below<sup>[1]</sup>?"
    ...
    <p align="center">
      <a href="../img/met_office_image.png" target="_blank">
        <img src="../img/met_office_image.png" alt="Weather app screenshot showing conditions in London. The display shows a temperature of 9°C, light showers, a 70% chance of rain, daily forecasts for several days, and hourly forecasts from 15:00 to 19:00." width="215" height="500">
      </a>
    </p>
    ...
    <p align="center">
    <a href="../img/met_office_image_circle.png" target="_blank">
    <img src="../img/met_office_image_circle.png" alt="Weather app screenshot showing current conditions and forecasts for London, with red circles added to highlight specific weather data elements such as temperature, forecast dates, times, and rainfall information." width="215" height="500"> 
    </a>
    </p>
...
!!! question ""
    ...
    2. **True or false: different data using different units of measurement can convey the same information**
        ...
        ??? success "Reveal answer"
            ...
            **TRUE** The same concept can be measured in different units.
