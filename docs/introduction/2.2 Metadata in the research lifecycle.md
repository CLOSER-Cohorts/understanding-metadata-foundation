...
??? success "Answers"
    ...
    - Metadata should be created only after the research project is completed. **FALSE** - Metadata should be created at the start and updated throughout the research lifecycle.
    - Another research project's metadata can help us in our own research study. **TRUE** - Other projects’ metadata helps us discover relevant datasets and assess whether they are suitable for our research.
    - Metadata is only useful during the data collection phase of research. **FALSE** - Metadata supports all stages of the research lifecycle, including design, analysis, archiving, and publication.
    - Provenance information is useful for assessing the reliability and quality of data. **TRUE** - Provenance metadata documents how data was created and processed, helping users judge its quality and trustworthiness.
