...
!!! example ""
    ...
    **Intended learning outcome**
    ...
    - Explain how metadata differs from other forms of data documentation
...
We can often (but not always) interpret the information without explanation, but we can misinterpret information without clear structure and definitions, for example, the name: Lee Thomas. Is Lee the first name or surname? Could it be Thomas Lee? 

Machines struggle even more, a computer does not: 
...
!!! question ""
    ...
    **Which of the following is a key purpose of metadata in research?**
    ...
    ??? success "Reveal answer"
         ...
         **Describing data content and structure.** Metadata is used to describe what the data contains, how it is structured, and how it was created. This makes it easier to understand, find, and reuse. The other options relate to data processing or security, not metadata.
    ...
    **Which of the following is _not_ typically included in research metadata?**
    ...
    ??? success "Reveal answer"
        ...
        **Data analysis results.** Metadata describes the data, not the findings derived from it. Information such as file size, creator, and licensing are standard metadata elements, whereas analysis results belong to research outputs, not metadata.
...
- <sup>[4]</sup> CODATA (2025) RDM Terminology: [metadata](https://terms.codata.org/rdmt/metadata)
