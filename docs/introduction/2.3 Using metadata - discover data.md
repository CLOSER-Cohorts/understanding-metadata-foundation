...
!!! question ""
    ...
    ??? success "Answers"
        ...
        - Data repositories and data catalogues are the same thing. **FALSE** - Repositories store the actual data, while catalogues store metadata to help users discover data.
        - Data catalogues store the actual research data. **FALSE** - Data catalogues contain metadata records and point users to where the data is held.
        - You can filter a data catalogue without metadata. **FALSE** - Search and filter functions rely on metadata.
        - A data dictionary includes analysis results and conclusions. **FALSE** - A data dictionary describes variables and data structure, not interpretations or research findings.
