...
!!! question ""
    ...
    **Why might the same concept be measured differently across datasets?**
    ...
    4. Because concepts can be operationalised in different ways  
    ...
    **How does concept metadata support interoperability across datasets?**
    ...
    ??? success "Reveal answer"
        ...
        Concept metadata allows users to recognise when different variables, questions, or codelists are measuring the same underlying idea. This supports interoperability by making it possible to link and compare data across different datasets, even when they are structured or labelled differently.
