...
>[!NOTE]
>Add reference as this looks like it was taken from DDI training slides
...
!!! question ""
    ...
    **Which of the following is an example of a concept?**
    ...
    ??? success "Reveal answer"
        ...
        Concepts are abstract ideas (e.g. socioeconomic status) that may be measured in different ways.

    **Why might the same concept be measured differently across datasets?**
    
    1. To reduce storage requirements  
    2. Because concepts can be operationalised in different ways  
    3. To ensure identical results  
    4. Because datasets must be unique  

    ??? success "Reveal answer"
    
        Concepts such as “income” or “wellbeing” can be defined and measured differently depending on context, purpose, or methodology.
    ...
    **What is the relationship between concepts and variables?**
    ...
    3. Variables are specific implementations used to measure broader concepts  
    4. They are unrelated  

    ??? success "Reveal answer"
    
        Concepts are abstract, while variables are the measurable representations used to capture them in data.


    **A researcher assumes two variables are comparable because they have similar names. What is the main risk if concept metadata is ignored?**
    
    1. Faster analysis  
    2. Reduced dataset size  
    3. Misinterpreting whether the same concept is being measured  
    4. Improved consistency  

    ??? success "Reveal answer"
    
        Similar labels do not guarantee conceptual equivalence, leading to potential misinterpretation.
