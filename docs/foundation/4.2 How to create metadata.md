...
!!! question ""
    ...
    **Why might you use more than one metadata tool in a project?**
    ...
    ??? success "Reveal answer"
        ...
        Different tools support different aspects of metadata management, such as creation, quality checking, or repository compliance.



    **Why is there no single recommended metadata tool for all projects?**
    
    1. Because metadata tools are rarely available  
    2. Because tools are only designed for specific datasets  
    3. Because the best tool depends on project context, needs, and intended use  
    4. Because all tools produce the same output  

    ??? success "Reveal answer"
    
        Tool choice depends on factors such as project scale, users, purpose, and how the metadata will be used.
