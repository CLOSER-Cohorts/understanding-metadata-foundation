...
!!! question ""
    ...
    **Which of the following best describes why data collection metadata is important?**
    ...
    1. It increases the size of the dataset  
    2. It explains how and under what conditions the data were created  
    3. It replaces the need for variable labels  
    4. It guarantees data accuracy  

    ??? success "Reveal answer"
    
        Data collection metadata provides essential context about how and under what conditions data were created, which supports correct interpretation and reuse.
    ...
    **Which of the following is an example of data collection metadata?**
    ...
    ??? success "Reveal answer"
        ...
        Mode of collection (e.g. online, telephone, face-to-face) is a key aspect of data collection metadata of survey data.
    ...
    **Why is sampling information important in data collection metadata?**
    ...
    ??? success "Reveal answer"
        ...
        Sampling metadata helps users judge how well findings can be generalised to the population.


    **Which of the following risks arises when data collection processes are not documented?**
    
    1. Faster analysis  
    2. Clearer variable definitions  
    3. Misinterpretation of results  
    4. Improved data consistency  

    ??? success "Reveal answer"
    
        Without documentation, users may misinterpret how the data were generated, leading to incorrect conclusions.
