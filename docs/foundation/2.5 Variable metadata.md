...
- [CLOSER Discovery](https://discovery.closer.ac.uk)
    ...
    They also provide information about the variables directly on these sites, allowing people to interact with variable metadata in a straightforward way.
...
- **Identification** (name, label, description) → what the variable is  
- **Data description** (value representation, data type, unit, valid range) → how data appears and can be interpreted  
- **Provenance** → how the variable was created or derived  
- **Statistics** (cases, missing values, validity) → how complete and reliable the data is  
